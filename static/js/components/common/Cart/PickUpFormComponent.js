...
import {Wrapper, Input, Label, NameBlock, TextArea} from './styled-components'
...
const coords = [
  ...
  point_id: "МД00008373",
  show_name: ".",
  address: "Москва г, Петровско-Разумовский проезд, 16. Время работы с 10.00 до 23.00",
  coords: [
  55.797574,
  37.569468
  ],
...
class PickUpForm extends Component { // eslint-disable-line react/prefer-stateless-function
  ...
  onHandlerClickList = (e) => {
    ...
    const address = e.currentTarget.childNodes[1].innerText
    ...
    //console.log("123", ref.current.childNodes[0].innerText)
  }
      ...
      <ThemeProvider theme={theme}>
        <Wrapper>
          ...
          <Row>
            ...
            <Col size={1}>
              <Label>E-mail</Label>
              <Input type="text" onChange={this.props.userInputHandler} value={this.props.emailValue} name="email" />
            </Col>
          </Row>
          <Row>
            <Col size={1}>
